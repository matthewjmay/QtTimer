...
const int MaxSeconds = 60 * MaxMinutes;
    ...
    : QWidget(parent)
{
    ...
    connect(updateTimer, &QTimer::timeout, this, static_cast<void (MyTimer::*)()>(&MyTimer::update));

    finishTimer = new QTimer(this);
    finishTimer->setSingleShot(true);
    connect(finishTimer, &QTimer::timeout, this, &MyTimer::timeout);
...
void MyTimer::setDuration(int secs)
{
...
void MyTimer::paintEvent(QPaintEvent * /* event */)
{
    ...
    int side = qMin<int>(width(), height());
...
void MyTimer::draw(QPainter *painter)
{
